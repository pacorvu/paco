...
router.post('/dashboard/placement/company', protect, authorize('admin', 'superadmin'), createCompany);
router.put('/dashboard/placement/company/:companyName', protect, authorize('admin', 'superadmin'), updateCompany);
