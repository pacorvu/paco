...
import { Box, Heading, Text, VStack, HStack, SimpleGrid, Image, Badge, Input, InputGroup, InputLeftElement, Spinner, Alert, AlertIcon, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalFooter, FormControl, FormLabel, Input as CInput, Tooltip } from '@chakra-ui/react';
...
function CompanyCard({ name, onOpen }) {
  ...
  return (
    <Tooltip label={name} placement="auto" hasArrow>
